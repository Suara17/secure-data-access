          ...
          <div className="bg-primary/10 border border-primary/20 rounded-lg p-4 space-y-2">
            ...
            <div className="grid grid-cols-2 gap-2 text-xs">
              <div className="bg-muted/50 rounded px-2 py-1">
                ...
                <span className="text-foreground font-mono ml-1">admin / admin123</span>
              </div>
              <div className="bg-muted/50 rounded px-2 py-1">
                <span className="text-muted-foreground">公开用户：</span>
                <span className="text-foreground font-mono ml-1">public_user / user123</span>
              </div>
              <div className="col-span-2 bg-muted/50 rounded px-2 py-1">
                <span className="text-muted-foreground">绝密用户：</span>
                <span className="text-foreground font-mono ml-1">secret_user / secret123</span>
              </div>
            </div>
          </div>
